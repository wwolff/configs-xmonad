...
layouts =
    modifiers . onWorkspaces (map show [2..4]) (workspaceDir cwd many) . onWorkspace "5" gimp
  ...
  where
    ...
    many = Tall 1 0.03 (13/22) ||| Full ||| Mirror (TallAlt 0.03 (31/44))
--  many = Mirror (Tall 1 0.03 (13/22)) ||| Full ||| Mirror (TallAlt 0.03 (31/44))
